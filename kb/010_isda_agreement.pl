...
It is permitted that a party designates that some Early Termination Date in respect of all outstanding Transactions occurs at a time T3
...
query one is:
It is permitted that which party designates that which event occurs at which time.
