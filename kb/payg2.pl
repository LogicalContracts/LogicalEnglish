...
scenario andrew_1 is:
    Andrew is the taxpayer.
    2025 is a year under consideration.
    the current quarter is quarter 1.
    the estimated taxable income for Andrew for 2025 is 100000.
    Andrew is a base rate entity.
    the tax offsets for Andrew for 2025 is 0.
    the estimated tax credits for Andrew for 2025 are 0.

scenario andrew_2 is:
    Andrew is the taxpayer.
    2025 is a year under consideration.
    the current quarter is quarter 2.
    the estimated taxable income for Andrew for 2025 is 50000.
    Andrew is a base rate entity.
    the tax offsets for Andrew for 2025 is 0.
    the estimated tax credits for Andrew for 2025 are 0.
    6250 with idiA202501 was reported as an instalment on quarter 1 of 2025.
    the estimated gross rent for Andrew for 2025 is 50000 with idegA2025.
