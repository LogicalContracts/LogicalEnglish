...
the knowledge base sbppscenario2 includes:
...
scenario 2 is:
the percentage of Tom Edwards revenue profits for BZJ Pty Ltd is 0.8.
BZJ Pty Ltd makes distribution of income during the relevant year.
the percentage of BZJ Pty Ltd revenue profits for Edward Family Trust is 0.5.
Edward Family Trust makes distribution of income during the relevant year.
the percentage of Edward Family Trust revenue profits for Tallow Unit Trust is 0.35.
