...
the knowledge base sbppxml3 includes:
...
% Capital statements
the percentage of Tom Hoskins capital profits from Hubble Unit Trust is 0.5.
the percentage of Hotskin Family Trust capital profits from Hubble Unit Trust is 0.5.
% Income Revenue statements
the percentage of Tom Hoskins revenue profits from Hubble Unit Trust is 0.8.
the percentage of Hotskin Family Trust revenue profits from Hubble Unit Trust is 0.2.
% Voting statements
the percentage of Tom Hoskins of the voting power in Hubble Unit Trust is 0.
...
% holds shares in
Tom Hoskins holds the legal and equitable interests in shares in Hubble Unit Trust.
Hotskin Family Trust holds the legal and equitable interests in shares in Hubble Unit Trust.
% Section: 
the relevant year is 2024.
% Capital statements
the percentage of XYZ Pty Ltd capital profits from Hotskin Family Trust is 0.
the percentage of Tom Hotskin capital profits from Hotskin Family Trust is 0.
% Income Revenue statements
the percentage of XYZ Pty Ltd revenue profits from Hotskin Family Trust is 0.
the percentage of Tom Hotskin revenue profits from Hotskin Family Trust is 0.
% Voting statements
...
% Capital statements
the percentage of XYZ Pty Ltd capital profits from Hotskin Family Trust is 0.5.
the percentage of Tom Hotskin capital profits from Hotskin Family Trust is 0.5.
% Income Revenue statements
...
query indirect is:
	the indirect small business participation percentage of Tom Hotskin in Hotskin Family Trust is which number.
    
query direct is:
	the direct small business participation percentage of Tom Hotskin in Hotskin Family Trust is which number.    
