...
mainGoal(has_affiliate(_Entity,_Affiliate),"Determine if a given entity is affiliate of another (also given)").
...
has_affiliate(Entity,Affiliate) on Date if 
...
/** <examples> 
?- query_with_facts(has_affiliate(andrew,company) on '20200101',test,Unknowns,Explanation,Result).
?- query_with_facts(has_affiliate(andrew,company) on '20200101',[acts_in_accordance_with_directions_from(company,andrew)],Unknowns,Explanation,Result).
?- le(LogicalEnglish).
*/