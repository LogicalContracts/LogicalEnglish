...
the indirect small business participation percentage of a holding entity in a testing entity is a percentage I 
    if the direct small business participation percentage of the holding entity in an intermediate entity is a number MyD
    and a number IT is the sum of each X such that
    	the direct small business participation percentage of the intermediate entity in the testing entity is a number DD
    	and the indirect small business participation percentage of the intermediate entity in the testing entity is a number ID
    	and X = DD + ID
    and I = MyD * IT. 
...
the direct small business participation percentage of an entity in a company C is a percentage I    
    ...
    and the percentage of the voting power of the entity in C is I
            and it is not the case that
                the entity jointly holds the legal and equitable interests in the shares of C with an other entity
        or  the percentage of any dividend C may pay is I
        or  the percentage of any distribution of capital C may make is I
        or  the percentage of the voting power of the entity in C is a VP
            and the percentage of any dividend C may pay is a D
            and the percentage of any distribution of capital C may make is a DC
...
the direct small business participation percentage of an entity in a trust T is a percentage I
    ...
    and the percentage of any distribution of income T may make to which the entity would be beneficially entitled is I
        ...
        or  percentage of any distribution of income T may make to which the entity would be beneficially entitled is a DI
...
the percentage of any distribution of income a trustee may make to which an entity would be beneficially entitled is a percentage X
    if the percentage of the trustee revenue profits for the entity is X.
...
the percentage of any distribution of capital a trustee may make to which an entity would be beneficially entitled is a percentage X
    if the percentage of the trustee capital profits for the entity is X.    
...
scenario two is:
    a holds the legal and equitable interests in shares in c.the percentage of any distribthe percentage of any distribution of income a trustee may make to which an entity would be beneficially entitled is a percentage X
    if the percentage of the trustee revenue profits for the entity is X.

the percentage of any distribution of capital a trustee may make to which an entity would be beneficially entitled is a percentage X
    if the percentage of the trustee capital profits for the entity is X.ution of income a trustee may make to which an entity would be beneficially entitled is a percentage X
    if the percentage of the trustee revenue profits for the entity is X.
