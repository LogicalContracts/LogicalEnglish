:-module('1_cgt_assets_and_exemptions_3',[]).
...
?- answer("one with scenario Colin").
?- answer(two, with('Colin'), le(R), An). 
?- answer("two with scenario Colin").
?- answer(three, with('Colin'), le(R), An). 
?- answer("three with scenario Colin").
*/  
