...
the borrower cures the failure of an obligation that the borrower pays an amount to the lender on a date
  if the borrower pays the amount to the lender on another date.
